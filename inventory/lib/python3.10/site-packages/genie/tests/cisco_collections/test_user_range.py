...
# 99.9% exact copy of Python's own Lib/test/test_range.py with range replaced
# by UserRange:
from genie.utils.cisco_collections import UserRange as range
...
class RangeTest(unittest.TestCase):
    ...
    def test_range(self):
        ...
        # XXXJST -- Inappropriate for UserRange (int() conversion)
        if False:
    ...
    def test_index(self):
        ...
        a = range(4)
        # XXXJST -- Inappropriate for UserRange:
        if False:
            self.assertRaises(BadExc, a.index, BadCmp())
        else:
            self.assertRaises(ValueError, a.index, BadCmp())
        ...
        if False:
            ...
            self.assertRaises(ValueError, range(10).index, always_equal)
    ...
    def test_repr(self):
        self.assertEqual(repr(range(1)), 'UserRange(0, 1)')
        self.assertEqual(repr(range(1, 2)), 'UserRange(1, 2)')
        self.assertEqual(repr(range(1, 2, 3)), 'UserRange(1, 2, 3)')
    ...
    # XXXJST -- UserRange iterator is not a range_iterator object
    if False:
    ...
    def test_types(self):
        ...
        if False:
            ...
            self.assertNotIn(C3(11), range(10))
