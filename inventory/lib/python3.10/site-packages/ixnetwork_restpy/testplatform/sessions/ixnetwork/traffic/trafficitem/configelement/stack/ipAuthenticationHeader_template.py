...
class IpAuthenticationHeader(Base):
    __slots__ = ()
    _SDM_NAME = "ipAuthenticationHeader"
    _SDM_ATT_MAP = {
        "HeaderNextHeader": "ipAuthenticationHeader.header.nextHeader-1",
        "HeaderPayloadLength": "ipAuthenticationHeader.header.payloadLength-2",
        "HeaderReserved": "ipAuthenticationHeader.header.reserved-3",
        "HeaderSpi": "ipAuthenticationHeader.header.spi-4",
        "HeaderSequenceNumberField": "ipAuthenticationHeader.header.sequenceNumberField-5",
        "HeaderIcv": "ipAuthenticationHeader.header.icv-6",
    }

    def __init__(self, parent, list_op=False):
        super(IpAuthenticationHeader, self).__init__(parent, list_op)
    ...
    @property
    def HeaderSequenceNumberField(self):
        """
        Display Name: Sequence Number Field
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["HeaderSequenceNumberField"])
        )
