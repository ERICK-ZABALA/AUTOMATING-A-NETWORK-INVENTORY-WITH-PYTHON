...
class Ipv6Authentication(Base):
    ...
    def AuthenticationHeaderNextHeader(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(self._SDM_ATT_MAP["AuthenticationHeaderNextHeader"]),
        )
    ...
    def AuthenticationHeaderPayloadLength(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(self._SDM_ATT_MAP["AuthenticationHeaderPayloadLength"]),
        )
    ...
    def AuthenticationHeaderReserved(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["AuthenticationHeaderReserved"])
        )
    ...
    def AuthenticationHeaderSpi(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["AuthenticationHeaderSpi"])
        )
    ...
    def AuthenticationHeaderSequenceNumber(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["AuthenticationHeaderSequenceNumber"]
            ),
        )
    ...
    def AuthenticationSha1(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["AuthenticationSha1"])
        )
    ...
    def AuthenticationMd5(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["AuthenticationMd5"])
        )
