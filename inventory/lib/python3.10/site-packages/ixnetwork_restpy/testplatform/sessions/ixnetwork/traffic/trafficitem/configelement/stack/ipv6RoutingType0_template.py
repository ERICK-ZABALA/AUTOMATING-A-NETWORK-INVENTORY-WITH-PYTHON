...
class Ipv6RoutingType0(Base):
    ...
    def RoutingHeaderType0NextHeader(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderType0NextHeader"])
        )
    ...
    def RoutingHeaderType0HeaderExtensionLength(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["RoutingHeaderType0HeaderExtensionLength"]
            ),
        )
    ...
    def RoutingHeaderType0RoutingType(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderType0RoutingType"]),
        )
    ...
    def RoutingHeaderType0SegmentsLeft(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderType0SegmentsLeft"]),
        )
    ...
    def RoutingHeaderType0Reserved(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderType0Reserved"])
        )
