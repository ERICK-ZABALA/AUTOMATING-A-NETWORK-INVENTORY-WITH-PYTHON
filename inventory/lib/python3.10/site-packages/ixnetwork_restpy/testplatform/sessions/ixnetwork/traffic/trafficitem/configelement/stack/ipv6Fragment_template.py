...
class Ipv6Fragment(Base):
    ...
    def FragmentHeaderNextHeader(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["FragmentHeaderNextHeader"])
        )
    ...
    def FragmentHeaderReserved1(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["FragmentHeaderReserved1"])
        )
    ...
    def FragmentHeaderFragmentOffset(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["FragmentHeaderFragmentOffset"])
        )
    ...
    def FragmentHeaderReserved2(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["FragmentHeaderReserved2"])
        )
    ...
    def FragmentHeaderMoreFragments(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["FragmentHeaderMoreFragments"])
        )
    ...
    def FragmentHeaderIdentification(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["FragmentHeaderIdentification"])
        )
