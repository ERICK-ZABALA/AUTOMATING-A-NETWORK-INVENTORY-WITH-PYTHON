...
class Ipv6(Base):
    ...
    def VersionTrafficClassFlowLabelVersion(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["VersionTrafficClassFlowLabelVersion"]
            ),
        )
    ...
    def VersionTrafficClassFlowLabelTrafficClass(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["VersionTrafficClassFlowLabelTrafficClass"]
            ),
        )
    ...
    def VersionTrafficClassFlowLabelFlowLabel(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["VersionTrafficClassFlowLabelFlowLabel"]
            ),
        )
