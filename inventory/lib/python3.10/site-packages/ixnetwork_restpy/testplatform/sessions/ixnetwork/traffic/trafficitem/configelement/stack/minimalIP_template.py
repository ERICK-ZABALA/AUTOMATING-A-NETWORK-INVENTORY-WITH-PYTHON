...
class MinimalIP(Base):
    ...
    def MinimalEncapsulationHeaderProtocol(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["MinimalEncapsulationHeaderProtocol"]
            ),
        )
    ...
    def MinimalEncapsulationHeaderSBit(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(self._SDM_ATT_MAP["MinimalEncapsulationHeaderSBit"]),
        )
    ...
    def MinimalEncapsulationHeaderReserved(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["MinimalEncapsulationHeaderReserved"]
            ),
        )
    ...
    def MinimalEncapsulationHeaderChecksum(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["MinimalEncapsulationHeaderChecksum"]
            ),
        )
    ...
    def MinimalEncapsulationHeaderOriginalDestinationAddress(self):
        ...
        return Multivalue(
            ...
            self._get_attribute(
                self._SDM_ATT_MAP[
                    "MinimalEncapsulationHeaderOriginalDestinationAddress"
                ]
            ),
        )
    ...
    def WithSourceOriginalSourceAddress(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(self._SDM_ATT_MAP["WithSourceOriginalSourceAddress"]),
        )
    ...
    def SourceOptionNoSource(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["SourceOptionNoSource"])
        )
