...
class Ipv6Routing(Base):
    ...
    def RoutingHeaderNextHeader(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderNextHeader"])
        )
    ...
    def RoutingHeaderHeaderExtensionLength(self):
        ...
        return Multivalue(
            self,
            self._get_attribute(
                self._SDM_ATT_MAP["RoutingHeaderHeaderExtensionLength"]
            ),
        )
    ...
    def RoutingHeaderRoutingType(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderRoutingType"])
        )
    ...
    def RoutingHeaderSegmentsLeft(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderSegmentsLeft"])
        )
    ...
    def RoutingHeaderRouteDataLength(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderRouteDataLength"])
        )
    ...
    def RoutingHeaderRouteData(self):
        ...
        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["RoutingHeaderRouteData"])
        )
