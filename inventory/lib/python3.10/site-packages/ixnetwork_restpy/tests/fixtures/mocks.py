...
class Mocks(object):
    ...
    REQUEST_RESPONSE = {
        ...
        "api/v1/sessions/1/ixnetwork": {
            "GET": {
                "data": {"href": "api/v1/sessions/1/ixnetwork"},
                "status_code": 200,
            }
        },
        "api/v1/sessions/1/ixnetwork/operations/select?xpath=false": {
            "POST": {
                "data": [
                    {
        ...
        "api/v1/sessions/1/ixnetwork/globals?includes=buildNumber,username": {
            "GET": {
                "data": {
    ...
    def mocked_request(**kwargs):
        class MockResponse:
            def __init__(self, response):
                ...
                self.headers = {"server": Mocks.PLATFORMS[Mocks._PLATFORM]}
